...
# Read data 
data1 = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "mu (1) n")
data2 = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "lx n")
data1 = data1[,1:31]
...
heatmap(heatmap_data, Rowv = NA, Colv = NA,
        ...
        ylab = "Y-axis Label",
        scale = "none")
write_xlsx(lc, "C:\\Users\\seraf\\Documents\\Heatmap Nigeria.xlsx")
#---------------------------------------------------------------------------------------
...
auto.arima(kt_ts) # 2,2,0

mod1 = Arima(kt_ts, order = c(2,2,0), include.drift = TRUE)
...
nmiu
write_xlsx(nmiu, "C:\\Users\\seraf\\Documents\\miu (1) nigeria.xlsx")

#---------------------------------------------------------------------------------------
# mu (tau)
data3 = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "mu (tau) n")
data4 = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "lx n")
data3 = data3[,1:31]
...
heatmap(heatmap_data2, Rowv = NA, Colv = NA,
        ...
        ylab = "Y-axis Label",
        scale = "none")
write_xlsx(lc2, "C:\\Users\\seraf\\Documents\\heatmap2 nigeria.xlsx")
#---------------------------------------------------------------------------------------
# Forecasting Lee Carter (new miu)
library(TSA)
kt2 = lc_model2$kt
...
auto.arima(kt_ts2) # 0,2,1

mod2 = Arima(kt_ts, order = c(0,2,1), include.drift = TRUE)
...
nmiu2
write_xlsx(nmiu2, "C:\\Users\\seraf\\Documents\\miu (tau) nigeria.xlsx")

#-------------------------------------------------------------------
# New qx (tau)
qx_tau = 1 - exp(-nmiu2)
write_xlsx(qx_tau, "C:\\Users\\seraf\\Documents\\qx (tau) nigeria.xlsx")
