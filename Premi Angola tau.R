...
# read data
data = read_excel("Proccessed2 Angola - Copy.xlsx", sheet = "PSD a")
data = data.frame(data)
loop0 = read_excel("Proccessed2 Angola - Copy.xlsx", sheet = "qx (tau) a")
loop0 = loop0[,-1]
...
#-------------------------------------------------------------------------------------------------
# read data
datam = read_excel("Proccessed2 Angola - Copy.xlsx", sheet = "PSD a")
datam = data.frame(datam)
loop0_m = read_excel("Proccessed2 Angola - Copy.xlsx", sheet = "qx (1) a")
loop0_m = loop0_m[,-1]
...
write_xlsx(Axn, "D:\\Axn tau Angola.xlsx")
write_xlsx(axn, "D:\\a_xn tau Angola.xlsx")  
write_xlsx(premi_tau, "D:\\premi tau Angola.xlsx")
write_xlsx(V_1_new, "D:\\1V tau Angola.xlsx")
write_xlsx(V_2_new, "D:\\2V tau Angola.xlsx")
write_xlsx(V_3_new, "D:\\3V tau Angola.xlsx")
write_xlsx(V_4_new, "D:\\4V tau Angola.xlsx")
write_xlsx(V_5_new, "D:\\5V tau Angola.xlsx")
write_xlsx(V_6_new, "D:\\6V tau Angola.xlsx")
write_xlsx(V_7_new, "D:\\7V tau Angola.xlsx")
write_xlsx(V_8_new, "D:\\8V tau Angola.xlsx")
write_xlsx(V_9_new, "D:\\9V tau Angola.xlsx")
write_xlsx(V_10_new, "D:\\10V tau Angola.xlsx")
