...
loop0 = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "qx (tau) n")
loop0 = loop0[,-1]
...
write_xlsx(V_1, "C:\\Users\\seraf\\Documents\\Hosea\\1V.xlsx")
...
#-------------------------------------------------------------------------------------------------
# read data
datam = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "PSD n")
datam = data.frame(datam)
loop0_m = read_excel("Proccessed2 Nigeria - Copy.xlsx", sheet = "qx (1) n")
loop0_m = loop0_m[,-1]
...
write_xlsx(Axn, "C:\\Users\\seraf\\Documents\\Axn tau Nigeria.xlsx")
write_xlsx(axn, "C:\\Users\\seraf\\Documents\\a_xn tau Nigeria.xlsx")  
write_xlsx(premi_tau, "C:\\Users\\seraf\\Documents\\premi tau Nigeria.xlsx")
write_xlsx(V_1_new, "C:\\Users\\seraf\\Documents\\1V tau Nigeria.xlsx")
write_xlsx(V_2_new, "C:\\Users\\seraf\\Documents\\2V tau Nigeria.xlsx")
write_xlsx(V_3_new, "C:\\Users\\seraf\\Documents\\3V tau Nigeria.xlsx")
write_xlsx(V_4_new, "C:\\Users\\seraf\\Documents\\4V tau Nigeria.xlsx")
write_xlsx(V_5_new, "C:\\Users\\seraf\\Documents\\5V tau Nigeria.xlsx")
write_xlsx(V_6_new, "C:\\Users\\seraf\\Documents\\6V tau Nigeria.xlsx")
write_xlsx(V_7_new, "C:\\Users\\seraf\\Documents\\7V tau Nigeria.xlsx")
write_xlsx(V_8_new, "C:\\Users\\seraf\\Documents\\8V tau Nigeria.xlsx")
write_xlsx(V_9_new, "C:\\Users\\seraf\\Documents\\9V tau Nigeria.xlsx")
write_xlsx(V_10_new, "C:\\Users\\seraf\\Documents\\10V tau Nigeria.xlsx")
...
premi_tau = premi_tau[1:90,1:30]
x = 1:90
premi_tau = cbind(x, premi_tau)
